...
export ENABLE_MODULES=none 
export PERSISTENCE_DATA_PATH="${ROCM_RAG_WORKSPACE}/rocm-rag/data/haystack/weaviate" 
...
> "${ROCM_RAG_WORKSPACE}/rocm-rag/logs/weaviate_extration.log" &
pids+=($!)
