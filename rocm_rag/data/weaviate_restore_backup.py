...
result = weaviate_client.backup.restore(
    ...
    backup_location=BackupLocation.FileSystem(path="/scratch/users/linsun12/agentic-ai-workspace/weaviate_backup"),  # Required if a non-default location was used at creation
)
